component hint="A User Object" output="false" persistent="true" accessors="true" {
	...
	property name="UserId" type="numeric" hint="unique id per user" fieldtype="id" elementtype="integer" generator="identity";
	...
	property name="Menus" type="array" hint="array of menus owned by this user"
				singularname="Menu" fieldtype="one-to-many" cfc="menu" fkcolumn="UserId"
